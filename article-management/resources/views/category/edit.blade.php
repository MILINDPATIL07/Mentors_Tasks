                    ...
                    <div class="row" style="padding-bottom:1%">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input name="status" value="active" type="radio" {{ $category->status == 'active' ? 'checked' : ''}} />active
                                <input name="status" value="inactive" type="radio" {{ $category->status == 'inactive' ? 'checked' : ''}} />inactive
