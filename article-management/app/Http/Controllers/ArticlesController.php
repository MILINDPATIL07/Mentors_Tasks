...
class ArticlesController extends Controller
{
    ...
    public function index()
    {
        ...
        $article = Article::select('articles.*', 'categories.cname', 'users.name')->join('categories', 'categories.id', '=', 'category')->join('users', 'users.id', '=', 'created_by')->where('categories.status', '=', 'active')->where('articles.status', '=', 'active')
            ->sortable()->paginate(5);
        // dd($article);
