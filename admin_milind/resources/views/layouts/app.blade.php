...
<head>
    ...
    <!-- Admin Validations External JavaScript -->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @if (Route::has('login'))
                        <li class="nav-item">
                            <a class="nav-link btn btn-warning" style="color:black"
                        ...
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="nav-link dropdown-toggle btn btn-warning" href="#"
                                role="button" style="color:black" data-bs-toggle="dropdown" aria-haspopup="true"
